---
title: "Compsci 216 Final Project: Using Linear Regression to Predict"
...
correlation_accuracy2
#correlation: .5689
#ok... but this model will vary depending on which observations end up in training and which end up in testing
